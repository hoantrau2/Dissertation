...
: ${AMENT_CURRENT_PREFIX:="/home/jetson/bbb_jetson_ws/src/install/bbb_package"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/bbb_package/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/bbb_package/environment/path.sh"
